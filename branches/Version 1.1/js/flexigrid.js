...
(function($){
        ...
        $.addFlex = function(t,p)
        {
              ...
              //create model if any
                if (p.colGroupModel)
                {
                        theadGroup = document.createElement('thead');
                        trGroup = document.createElement('tr');
                        
                        for (i=0;i<p.colGroupModel.length;i++)
                                {
                                        var cgm = p.colGroupModel[i];
                                        var thgroup = document.createElement('th');

                                        thgroup.innerHTML = cgm.display;
                                        
                                        
                                        if (cgm.align)
                                        	thgroup.align = cgm.align;
                                                
                                        if (cgm.width) 
                                                $(thgroup).attr('width',cgm.width);


                                        $(trGroup).append(thgroup);
                                }
                        $(theadGroup).append(trGroup);
                        $(t).prepend(theadGroup);
                } // end if p.colGroupModel  
                
                //init divs
                g.gDiv = document.createElement('div'); //create global container
                g.mDiv = document.createElement('div'); //create title container
                g.ghDiv = document.createElement('div'); //create group header container
                ...
                g.ghTable = document.createElement('table');
                ...
                g.ghDiv.className = 'ghDiv';

                $(t).before(g.ghDiv);

                //set ghTable
                        g.ghTable.cellPadding = 0;
                        g.ghTable.cellSpacing = 0;
                        $(g.ghDiv).append('<div class="ghDivBox"></div>');
                        $('div',g.ghDiv).append(g.ghTable);
                        var theadGroup = $("thead:first",t).get(0);
                        if (theadGroup) $(g.ghTable).append(theadGroup);
                        theadGroup = null;
                
                if (!p.colGroupModel) var ci = 0;

                //setup thead                   
                        $('thead tr:first th',g.ghDiv).each
                        (
                                function ()
                                        {
