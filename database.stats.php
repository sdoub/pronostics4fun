...
<title>' . __encode("Pronostics4Fun - Statistiques de la base de donn�es") . '</title>
 ...
 * @param string $lang indique la langue des unit�s de taille
 * @return string chaine de caract�res format�es
 */
function formatSize($bytes,$format = '%.2f',$lang = 'en')
{
	...
	$b = (double)$bytes;
	/*On g�re le cas des tailles de fichier n�gatives*/
	if($b > 0)
	{
		$e = (int)(log($b,1024));
		/**Si on a pas l'unit� on retourne en To*/
