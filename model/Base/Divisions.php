...
/**
 * Base class that represents a row from the 'divisions' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Divisions implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\DivisionsTableMap';
    ...
    /**
     * Initializes internal state of Base\Divisions object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Divisions</code> instance.  If
     * <code>obj</code> is an instance of <code>Divisions</code>, delegates to
     * <code>equals(Divisions)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Divisions The current object, for fluid interface
     */
    ...
    public function setDivisionPK($v)
    {
        ...
        if ($this->primarykey !== $v) {
            $this->primarykey = $v;
            $this->modifiedColumns[DivisionsTableMap::COL_PRIMARYKEY] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[DivisionsTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[DivisionsTableMap::COL_CODE] = true;
        }
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[DivisionsTableMap::COL_ORDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DivisionsTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DivisionsTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = DivisionsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Divisions'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDivisionsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Divisions::setDeleted()
     * @see Divisions::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDivisionsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DivisionsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DivisionsTableMap::COL_PRIMARYKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PrimaryKey';
        }
        if ($this->isColumnModified(DivisionsTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'Description';
        }
        if ($this->isColumnModified(DivisionsTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'Code';
        }
        if ($this->isColumnModified(DivisionsTableMap::COL_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'Order';
        }

        $sql = sprintf(
            'INSERT INTO divisions (%s) VALUES (%s)',
    ...
    {
        $pos = DivisionsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DivisionsTableMap::COL_PRIMARYKEY)) {
            $criteria->add(DivisionsTableMap::COL_PRIMARYKEY, $this->primarykey);
        }
        if ($this->isColumnModified(DivisionsTableMap::COL_DESCRIPTION)) {
            $criteria->add(DivisionsTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(DivisionsTableMap::COL_CODE)) {
            $criteria->add(DivisionsTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(DivisionsTableMap::COL_ORDER)) {
            $criteria->add(DivisionsTableMap::COL_ORDER, $this->order);
        }
    ...
    {
        $criteria = ChildDivisionsQuery::create();
        $criteria->add(DivisionsTableMap::COL_PRIMARYKEY, $this->primarykey);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Divisions (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Divisions Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(DivisionsTableMap::DEFAULT_STRING_FORMAT);
    }
