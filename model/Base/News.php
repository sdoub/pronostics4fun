...
abstract class News implements ActiveRecordInterface
{
    ...
    /**
     * The value for the infodate field.
    ...
    /**
     * The value for the infotype field.
    ...
    /**
     * Get the [optionally formatted] temporal [infodate] column value.
     *
     *
     ...
     */
    public function getInfodate($format = NULL)
    {
        if ($format === null) {
            return $this->infodate;
        } else {
            return $this->infodate instanceof \DateTime ? $this->infodate->format($format) : null;
        }
    }

    /**
     * Get the [infotype] column value.
     *
     * @return boolean
     */
    ...
    public function setNewsPK($v)
    {
        ...
        if ($this->primarykey !== $v) {
            $this->primarykey = $v;
            $this->modifiedColumns[NewsTableMap::COL_PRIMARYKEY] = true;
        }
    ...
    public function setCompetitionkey($v)
    {
        ...
        if ($this->competitionkey !== $v) {
            ...
            $this->modifiedColumns[NewsTableMap::COL_COMPETITIONKEY] = true;
        }
    ...
    public function setInformation($v)
    {
        ...
        if ($this->information !== $v) {
            $this->information = $v;
            $this->modifiedColumns[NewsTableMap::COL_INFORMATION] = true;
        }
    ...
    /**
     * Sets the value of [infodate] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTime value.
     *               Empty strings are treated as NULL.
     * @return $this|\News The current object (for fluent API support)
     */
    public function setInfodate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->infodate !== null || $dt !== null) {
            if ($this->infodate === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->infodate->format("Y-m-d H:i:s")) {
                $this->infodate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[NewsTableMap::COL_INFODATE] = true;
            }
    ...
    /**
     * Sets the value of the [infotype] column.
    ...
    public function setInfotype($v)
    {
        ...
        if ($this->infotype !== $v) {
            $this->infotype = $v;
            $this->modifiedColumns[NewsTableMap::COL_INFOTYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NewsTableMap::translateFieldName('Information', TableMap::TYPE_PHPNAME, $indexType)];
            $this->information = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NewsTableMap::translateFieldName('Infodate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->infodate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : NewsTableMap::translateFieldName('Infotype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->infotype = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->primarykey) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . NewsTableMap::COL_PRIMARYKEY . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(NewsTableMap::COL_PRIMARYKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PrimaryKey';
        }
        if ($this->isColumnModified(NewsTableMap::COL_COMPETITIONKEY)) {
            $modifiedColumns[':p' . $index++]  = 'CompetitionKey';
        }
        if ($this->isColumnModified(NewsTableMap::COL_INFORMATION)) {
            $modifiedColumns[':p' . $index++]  = 'Information';
        }
        if ($this->isColumnModified(NewsTableMap::COL_INFODATE)) {
            $modifiedColumns[':p' . $index++]  = 'InfoDate';
        }
        if ($this->isColumnModified(NewsTableMap::COL_INFOTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'InfoType';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Information':
                        ...
                        break;
                    case 'InfoDate':
                        $stmt->bindValue($identifier, $this->infodate ? $this->infodate->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                    case 'InfoType':
                        $stmt->bindValue($identifier, (int) $this->infotype, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setInformation($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setInfodate($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setInfotype($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_PRIMARYKEY)) {
            $criteria->add(NewsTableMap::COL_PRIMARYKEY, $this->primarykey);
        }
        if ($this->isColumnModified(NewsTableMap::COL_COMPETITIONKEY)) {
            $criteria->add(NewsTableMap::COL_COMPETITIONKEY, $this->competitionkey);
        }
        if ($this->isColumnModified(NewsTableMap::COL_INFORMATION)) {
            $criteria->add(NewsTableMap::COL_INFORMATION, $this->information);
        }
        if ($this->isColumnModified(NewsTableMap::COL_INFODATE)) {
            $criteria->add(NewsTableMap::COL_INFODATE, $this->infodate);
        }
        if ($this->isColumnModified(NewsTableMap::COL_INFOTYPE)) {
            $criteria->add(NewsTableMap::COL_INFOTYPE, $this->infotype);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setInfodate($this->getInfodate());
    ...
    public function getCompetitions(ConnectionInterface $con = null)
    {
        if ($this->aCompetitions === null && ($this->competitionkey !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompetitions->addNews($this);
             */
        }
    ...
    {
        if (null !== $this->aCompetitions) {
            $this->aCompetitions->removeNews($this);
        }
