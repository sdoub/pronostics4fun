 ...
 *
 */
class OwnGoalQuery extends GoalQuery
{

    /**
     * Returns a new \OwnGoalQuery object.
     *
    ...
    {
        if ($criteria instanceof \OwnGoalQuery) {
            return $criteria;
        }
        $query = new \OwnGoalQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only OwnGoal objects.
     */
    public function preSelect(ConnectionInterface $con)
    {
        $this->addUsingAlias(EventsTableMap::COL_EVENTTYPE, EventsTableMap::CLASSKEY_3);
    }
