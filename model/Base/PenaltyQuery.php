 ...
 *
 */
class PenaltyQuery extends GoalQuery
{

    /**
     * Returns a new \PenaltyQuery object.
     *
    ...
    {
        if ($criteria instanceof \PenaltyQuery) {
            return $criteria;
        }
        $query = new \PenaltyQuery();
        if (null !== $modelAlias) {
    ...
    /**
     * Filters the query to target only Penalty objects.
     */
    public function preSelect(ConnectionInterface $con)
    {
        $this->addUsingAlias(EventsTableMap::COL_EVENTTYPE, EventsTableMap::CLASSKEY_2);
    }
