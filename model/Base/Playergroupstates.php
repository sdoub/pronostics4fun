...
/**
 * Base class that represents a row from the 'playergroupstates' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Playergroupstates implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PlayergroupstatesTableMap';
    ...
    /**
     * Initializes internal state of Base\Playergroupstates object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Playergroupstates</code> instance.  If
     * <code>obj</code> is an instance of <code>Playergroupstates</code>, delegates to
     * <code>equals(Playergroupstates)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Playergroupstates The current object, for fluid interface
     */
    ...
    public function setStatedate($v)
    {
        ...
        if ($this->statedate !== null || $dt !== null) {
            if ($this->statedate === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->statedate->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[PlayergroupstatesTableMap::COL_STATEDATE] = true;
            }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[PlayergroupstatesTableMap::COL_RANK] = true;
        }
    ...
    public function setScore($v)
    {
        ...
        if ($this->score !== $v) {
            $this->score = $v;
            $this->modifiedColumns[PlayergroupstatesTableMap::COL_SCORE] = true;
        }
    ...
    public function setBonus($v)
    {
        ...
        if ($this->bonus !== $v) {
            $this->bonus = $v;
            $this->modifiedColumns[PlayergroupstatesTableMap::COL_BONUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PlayergroupstatesTableMap::translateFieldName('Playerkey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->playerkey = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PlayergroupstatesTableMap::translateFieldName('Groupkey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->groupkey = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PlayergroupstatesTableMap::translateFieldName('Statedate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->statedate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PlayergroupstatesTableMap::translateFieldName('Rank', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rank = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PlayergroupstatesTableMap::translateFieldName('Score', TableMap::TYPE_PHPNAME, $indexType)];
            $this->score = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PlayergroupstatesTableMap::translateFieldName('Bonus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bonus = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = PlayergroupstatesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Playergroupstates'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPlayergroupstatesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Playergroupstates::setDeleted()
     * @see Playergroupstates::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPlayergroupstatesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PlayergroupstatesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_PLAYERKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PlayerKey';
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_GROUPKEY)) {
            $modifiedColumns[':p' . $index++]  = 'GroupKey';
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_STATEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'StateDate';
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_RANK)) {
            $modifiedColumns[':p' . $index++]  = 'Rank';
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_SCORE)) {
            $modifiedColumns[':p' . $index++]  = 'Score';
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_BONUS)) {
            $modifiedColumns[':p' . $index++]  = 'Bonus';
        }

        $sql = sprintf(
            'INSERT INTO playergroupstates (%s) VALUES (%s)',
    ...
    {
        $pos = PlayergroupstatesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Playergroupstates'][$this->hashCode()] = true;
        $keys = PlayergroupstatesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_PLAYERKEY)) {
            $criteria->add(PlayergroupstatesTableMap::COL_PLAYERKEY, $this->playerkey);
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_GROUPKEY)) {
            $criteria->add(PlayergroupstatesTableMap::COL_GROUPKEY, $this->groupkey);
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_STATEDATE)) {
            $criteria->add(PlayergroupstatesTableMap::COL_STATEDATE, $this->statedate);
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_RANK)) {
            $criteria->add(PlayergroupstatesTableMap::COL_RANK, $this->rank);
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_SCORE)) {
            $criteria->add(PlayergroupstatesTableMap::COL_SCORE, $this->score);
        }
        if ($this->isColumnModified(PlayergroupstatesTableMap::COL_BONUS)) {
            $criteria->add(PlayergroupstatesTableMap::COL_BONUS, $this->bonus);
        }
    ...
    {
        $criteria = ChildPlayergroupstatesQuery::create();
        $criteria->add(PlayergroupstatesTableMap::COL_PLAYERKEY, $this->playerkey);
        $criteria->add(PlayergroupstatesTableMap::COL_GROUPKEY, $this->groupkey);
        $criteria->add(PlayergroupstatesTableMap::COL_STATEDATE, $this->statedate);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[1] = $this->getGroupkey();
        $pks[2] = $this->getStatedate();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setGroupkey($keys[1]);
        $this->setStatedate($keys[2]);
    }
    ...
    {
        return (null === $this->getPlayerkey()) && (null === $this->getGroupkey()) && (null === $this->getStatedate());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Playergroupstates (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Playergroupstates Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PlayergroupstatesTableMap::DEFAULT_STRING_FORMAT);
    }
