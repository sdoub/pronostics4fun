...
abstract class Results implements ActiveRecordInterface
{
    ...
    /**
     * The value for the livestatus field.
     * @var        int
     */
    protected $livestatus;

    /**
     * The value for the actualtime field.
     * @var        int
     */
    ...
    /**
     * Get the [livestatus] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [actualtime] column value.
     *
     * @return int
     */
    ...
    public function setPrimarykey($v)
    {
        ...
        if ($this->primarykey !== $v) {
            $this->primarykey = $v;
            $this->modifiedColumns[ResultsTableMap::COL_PRIMARYKEY] = true;
        }
    ...
    /**
     * Set the value of [livestatus] column.
     *
     * @param int $v new value
     * @return $this|\Results The current object (for fluent API support)
     */
    public function setLivestatus($v)
    {
        ...
        if ($this->livestatus !== $v) {
            $this->livestatus = $v;
            $this->modifiedColumns[ResultsTableMap::COL_LIVESTATUS] = true;
        }
    ...
    /**
     * Set the value of [actualtime] column.
     *
     * @param int $v new value
     * @return $this|\Results The current object (for fluent API support)
     */
    public function setActualtime($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->actualtime !== $v) {
            $this->actualtime = $v;
            $this->modifiedColumns[ResultsTableMap::COL_ACTUALTIME] = true;
        }
    ...
    public function setResultdate($v)
    {
        ...
        if ($this->resultdate !== null || $dt !== null) {
            if ($this->resultdate === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->resultdate->format("Y-m-d H:i:s")) {
                $this->resultdate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[ResultsTableMap::COL_RESULTDATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ResultsTableMap::translateFieldName('Livestatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->livestatus = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ResultsTableMap::translateFieldName('Actualtime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->actualtime = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ResultsTableMap::translateFieldName('Resultdate', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ResultsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ResultsTableMap::COL_PRIMARYKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PrimaryKey';
        }
        if ($this->isColumnModified(ResultsTableMap::COL_MATCHKEY)) {
            $modifiedColumns[':p' . $index++]  = 'MatchKey';
        }
        if ($this->isColumnModified(ResultsTableMap::COL_LIVESTATUS)) {
            $modifiedColumns[':p' . $index++]  = 'LiveStatus';
        }
        if ($this->isColumnModified(ResultsTableMap::COL_ACTUALTIME)) {
            $modifiedColumns[':p' . $index++]  = 'ActualTime';
        }
        if ($this->isColumnModified(ResultsTableMap::COL_RESULTDATE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'MatchKey':
                        ...
                        break;
                    case 'LiveStatus':
                        $stmt->bindValue($identifier, $this->livestatus, PDO::PARAM_INT);
                        break;
                    case 'ActualTime':
                        $stmt->bindValue($identifier, $this->actualtime, PDO::PARAM_INT);
                        break;
                    case 'ResultDate':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setLivestatus($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setActualtime($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setResultdate($arr[$keys[4]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ResultsTableMap::COL_PRIMARYKEY)) {
            $criteria->add(ResultsTableMap::COL_PRIMARYKEY, $this->primarykey);
        }
        if ($this->isColumnModified(ResultsTableMap::COL_MATCHKEY)) {
            $criteria->add(ResultsTableMap::COL_MATCHKEY, $this->matchkey);
        }
        if ($this->isColumnModified(ResultsTableMap::COL_LIVESTATUS)) {
            $criteria->add(ResultsTableMap::COL_LIVESTATUS, $this->livestatus);
        }
        if ($this->isColumnModified(ResultsTableMap::COL_ACTUALTIME)) {
            $criteria->add(ResultsTableMap::COL_ACTUALTIME, $this->actualtime);
        }
        if ($this->isColumnModified(ResultsTableMap::COL_RESULTDATE)) {
            $criteria->add(ResultsTableMap::COL_RESULTDATE, $this->resultdate);
        }
