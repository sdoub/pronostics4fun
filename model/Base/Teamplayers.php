...
/**
 * Base class that represents a row from the 'teamplayers' table.
 *
 *
 *
* @package    propel.generator..Base
*/
abstract class Teamplayers implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TeamplayersTableMap';
    ...
    /**
     * Initializes internal state of Base\Teamplayers object.
     */
    ...
    /**
     * Compares this with another <code>Teamplayers</code> instance.  If
     * <code>obj</code> is an instance of <code>Teamplayers</code>, delegates to
     * <code>equals(Teamplayers)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Teamplayers The current object, for fluid interface
     */
    ...
    public function setTeamPlayerPK($v)
    {
        ...
        if ($this->primarykey !== $v) {
            $this->primarykey = $v;
            $this->modifiedColumns[TeamplayersTableMap::COL_PRIMARYKEY] = true;
        }
    ...
    public function setFullname($v)
    {
        ...
        if ($this->fullname !== $v) {
            $this->fullname = $v;
            $this->modifiedColumns[TeamplayersTableMap::COL_FULLNAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = TeamplayersTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Teamplayers'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTeamplayersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Teamplayers::setDeleted()
     * @see Teamplayers::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTeamplayersQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TeamplayersTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamplayersTableMap::COL_PRIMARYKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PrimaryKey';
        }
        if ($this->isColumnModified(TeamplayersTableMap::COL_FULLNAME)) {
            $modifiedColumns[':p' . $index++]  = 'FullName';
        }

        $sql = sprintf(
            'INSERT INTO teamplayers (%s) VALUES (%s)',
    ...
    {
        $pos = TeamplayersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Teamplayers'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamplayersTableMap::COL_PRIMARYKEY)) {
            $criteria->add(TeamplayersTableMap::COL_PRIMARYKEY, $this->primarykey);
        }
        if ($this->isColumnModified(TeamplayersTableMap::COL_FULLNAME)) {
            $criteria->add(TeamplayersTableMap::COL_FULLNAME, $this->fullname);
        }
    ...
    {
        $criteria = ChildTeamplayersQuery::create();
        $criteria->add(TeamplayersTableMap::COL_PRIMARYKEY, $this->primarykey);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Teamplayers (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Teamplayers Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildTeamplayers is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTeamplayers The current object (for fluent API support)
     */
    public function setEventss(Collection $eventss, ConnectionInterface $con = null)
    {
        ...
        foreach ($eventssToDelete as $eventsRemoved) {
            $eventsRemoved->setTeamplayers(null);
        }
     ...
     * Otherwise if this Teamplayers is new, it will return
     * an empty collection; or if this Teamplayers has previously
     * been saved, it will retrieve related Eventss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Teamplayers.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setLineupss(Collection $lineupss, ConnectionInterface $con = null)
    {
        ...
        foreach ($lineupssToDelete as $lineupsRemoved) {
            $lineupsRemoved->setLineUpTeamPlayer(null);
        }
    ...
    protected function doAddLineups(ChildLineups $lineups)
    {
        ...
        $lineups->setLineUpTeamPlayer($this);
    }
    ...
    public function removeLineups(ChildLineups $lineups)
    {
        if ($this->getLineupss()->contains($lineups)) {
            ...
            $lineups->setLineUpTeamPlayer(null);
        }
    ...
    {
        return (string) $this->exportTo(TeamplayersTableMap::DEFAULT_STRING_FORMAT);
    }
