...
abstract class Votes implements ActiveRecordInterface
{
    ...
    /**
     * The value for the votedate field.
    ...
    /**
     * Get the [optionally formatted] temporal [votedate] column value.
     *
     *
     ...
     */
    public function getVotedate($format = NULL)
    {
        if ($format === null) {
            return $this->votedate;
        } else {
            return $this->votedate instanceof \DateTime ? $this->votedate->format($format) : null;
        }
    }
    ...
    public function setVotePK($v)
    {
        ...
        if ($this->primarykey !== $v) {
            $this->primarykey = $v;
            $this->modifiedColumns[VotesTableMap::COL_PRIMARYKEY] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[VotesTableMap::COL_VALUE] = true;
        }
    ...
    /**
     * Sets the value of [votedate] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTime value.
     *               Empty strings are treated as NULL.
     * @return $this|\Votes The current object (for fluent API support)
     */
    public function setVotedate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->votedate !== null || $dt !== null) {
            if ($this->votedate === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->votedate->format("Y-m-d H:i:s")) {
                $this->votedate = $dt === null ? null : clone $dt;
                $this->modifiedColumns[VotesTableMap::COL_VOTEDATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VotesTableMap::translateFieldName('Playerkey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->playerkey = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VotesTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VotesTableMap::translateFieldName('Votedate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->votedate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            $this->resetModified();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VotesTableMap::COL_PRIMARYKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PrimaryKey';
        }
        if ($this->isColumnModified(VotesTableMap::COL_MATCHKEY)) {
            $modifiedColumns[':p' . $index++]  = 'MatchKey';
        }
        if ($this->isColumnModified(VotesTableMap::COL_PLAYERKEY)) {
            $modifiedColumns[':p' . $index++]  = 'PlayerKey';
        }
        if ($this->isColumnModified(VotesTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'Value';
        }
        if ($this->isColumnModified(VotesTableMap::COL_VOTEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'VoteDate';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Value':
                        ...
                        break;
                    case 'VoteDate':
                        $stmt->bindValue($identifier, $this->votedate ? $this->votedate->format("Y-m-d H:i:s") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VotesTableMap::COL_PRIMARYKEY)) {
            $criteria->add(VotesTableMap::COL_PRIMARYKEY, $this->primarykey);
        }
        if ($this->isColumnModified(VotesTableMap::COL_MATCHKEY)) {
            $criteria->add(VotesTableMap::COL_MATCHKEY, $this->matchkey);
        }
        if ($this->isColumnModified(VotesTableMap::COL_PLAYERKEY)) {
            $criteria->add(VotesTableMap::COL_PLAYERKEY, $this->playerkey);
        }
        if ($this->isColumnModified(VotesTableMap::COL_VALUE)) {
            $criteria->add(VotesTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(VotesTableMap::COL_VOTEDATE)) {
            $criteria->add(VotesTableMap::COL_VOTEDATE, $this->votedate);
        }
