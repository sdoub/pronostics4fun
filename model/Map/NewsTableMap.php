...
class NewsTableMap extends TableMap
{
     ...
     */
    const COL_PRIMARYKEY = 'news.PrimaryKey';

    /**
     * the column name for the CompetitionKey field
     */
    const COL_COMPETITIONKEY = 'news.CompetitionKey';

    /**
     * the column name for the Information field
     */
    const COL_INFORMATION = 'news.Information';

    /**
     * the column name for the InfoDate field
     */
    const COL_INFODATE = 'news.InfoDate';

    /**
     * the column name for the InfoType field
     */
    const COL_INFOTYPE = 'news.InfoType';
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(NewsTableMap::COL_PRIMARYKEY);
            $criteria->addSelectColumn(NewsTableMap::COL_COMPETITIONKEY);
            $criteria->addSelectColumn(NewsTableMap::COL_INFORMATION);
            $criteria->addSelectColumn(NewsTableMap::COL_INFODATE);
            $criteria->addSelectColumn(NewsTableMap::COL_INFOTYPE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.InfoDate');
            $criteria->addSelectColumn($alias . '.InfoType');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(NewsTableMap::COL_PRIMARYKEY, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(NewsTableMap::COL_PRIMARYKEY) && $criteria->keyContainsValue(NewsTableMap::COL_PRIMARYKEY) ) {
