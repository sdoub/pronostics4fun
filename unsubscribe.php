	...
	<div id="container">
    	...
    	<div id="divConfirm" style="height:120px;margin-top:50px;margin-right:150px;margin-left:150px;">
        	<div style="height:120px;border: solid 1px #365F89;background: #d6e1f5;">
            	...
            	<?php if ($_GET["type"]==2) {?>
            	<p style="color:#365F89;font-size:12px;"><?php echo __encode("Etes vous sur de ne plus vouloir recevoir les résultats par email ?")?></p>
            	<?php } else if ($_GET["type"]==1) {?>
            	<p style="color:#365F89;font-size:12px;"><?php echo __encode("Etes vous sur de ne plus vouloir recevoir les alertes pour les matchs non pronostiqués ?")?></p>
            	<?php } ?>
        		<p style="color:#365F89;font-size:10px; margin-top:30px;"><?php echo __encode("p.s. : Si vous vous désabonnez, vous pourrez toujours ré-activer cette option à partir de l'écran détail de votre compte.")?></p>
        	</div>
    	...
    	<div id="divResult" style="height:120px;margin-top:50px;margin-right:150px;margin-left:150px;display:none;" >
        	<div style="height:120px;border: solid 1px #365F89;background: #d6e1f5;">
            	...
            	<?php if ($_GET["type"]==2) {?>
            	<p style="color:#365F89;font-size:12px;"><?php echo __encode("A partir de maintenant vous ne recevrez plus l'email vous informant des résultats d'une journée de championnat.")?></p>
            	<?php } else if ($_GET["type"]==1) {?>
            	<p style="color:#365F89;font-size:12px;"><?php echo __encode("A partir de maintenant, vous ne recevrez plus l'email de rappel, 1 jour, avant un match non pronostiqué.")?></p>
            	<?php } ?>

        		<p style="color:#365F89;font-size:10px; margin-top:25px;"><?php echo __encode("p.s. : Si vous changez d'avis, vous pourrez toujours ré-activer cette option à partir de l'écran détail de votre compte.")?></p>
        	</div>
